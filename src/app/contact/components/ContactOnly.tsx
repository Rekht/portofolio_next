// components/ContactSection.tsx - Komponen section kontak
...
const ContactSection: React.FC = () => {
  return (
    <section className="w-full" id="contact">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 container mx-auto px-6 md:px-16 items-center">

...
export default function ProjectClient({ projectsData }: ProjectClientProps) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans relative pb-20">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-accent-gradient-to/5 rounded-full blur-[120px] translate-y-1/2 -translate-x-1/3" />
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 md:px-12 pt-12 md:pt-20">
        ...
        >
          ...
          <h1 className="text-3xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-accent-gradient-from to-accent-gradient-to bg-clip-text text-transparent">
            {project.title}
          </h1>

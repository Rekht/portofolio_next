                ...
                initialExperience.map((exp) => (
                  <tr key={exp.id} className="hover:bg-secondary/30 transition-colors">
                    ...
                    <td className="px-4 py-3 text-right">
                      <button onClick={() => handleEdit(exp)} className="p-2 text-blue-500 hover:bg-blue-500/10 rounded-lg transition-colors mr-2">Edit</button>
                      <button onClick={() => handleDelete(exp.id)} className="p-2 text-red-500 hover:bg-red-500/10 rounded-lg transition-colors">Delete</button>
                    </td>
                  </tr>
                ))
              )}

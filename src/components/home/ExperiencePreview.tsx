      ...
      >
        <div className="relative flex justify-center items-center mb-8">
          ...
          <div className="absolute right-0">
            <button
              onClick={handleViewAll}
              className="group flex items-center gap-2 px-4 py-2 bg-primary/10 text-primary hover:bg-primary hover:text-primary-foreground rounded-full transition-all duration-300 font-medium text-sm"
            >
